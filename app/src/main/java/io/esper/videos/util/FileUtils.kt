...
import io.esper.videos.constants.Constants
import io.esper.videos.constants.Constants.FileUtilsTag
                        ...
                        getMimeType(currentFile)!!.contains("video") || getMimeType(currentFile)!!.contains(
                            ...
                            for (i in audiosVideos.indices) {
                                if ((getExtension(currentItem.name!!) in audiosVideos[i]!!) && !currentItem.name!!.startsWith(
                                    ...
                                    if (videoFileIsCorrupted(context, currentItem.path!!))
                                        fileList.add(currentItem)
                                }
                            }
                        }
...
//                        fileList.add(currentItem)
    ...
    private fun videoFileIsCorrupted(mContext: Context, path: String): Boolean {
