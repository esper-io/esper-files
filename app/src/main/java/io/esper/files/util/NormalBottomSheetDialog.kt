...
class NormalBottomSheetDialog(videoPath: String) : BottomSheetDialogFragment() {

    private var fullscreenButtonFrame: FrameLayout? = null
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(
            R.layout.normal_bottom_sheet_layout,
            container, false
        )
        ...
        //fullscreenButtonFrame = v.findViewById(R.id.exo_fullscreen_button)
        return v
    }
